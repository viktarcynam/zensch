...
class StreamingService:
    ...
    def start_streaming(self):
        ...
        return {"success": True, "message": "Streaming is disabled."}
    ...
    def add_stock_subscription(self, symbol: str) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary with success/error information
        """
        logger.info("Streaming is disabled. Not adding stock subscription.")
        return {"success": True, "message": "Streaming is disabled."}
        # if not self.schwab_client:
        #     logger.error("Schwab client not set in streaming service")
        #     return {
    ...
    def add_option_subscriptions(self, symbol: str, expiration_date: str, 
        ...
        Returns:
            Dictionary with success/error information
        """
        logger.info("Streaming is disabled. Not adding option subscription.")
        return {"success": True, "message": "Streaming is disabled."}
        # if not self.schwab_client:
        #     logger.error("Schwab client not set in streaming service")
        #     return {
    ...
    def _update_subscriptions(self):
        ...
        logger.info("Streaming is disabled. Not updating subscriptions.")
        return
