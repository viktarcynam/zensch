...
def main():
    ...
    with SchwabClient() as client:
        ...
        # Fetch working option orders with a limit
        orders_response = client.get_option_orders(account_id=account_hash, status='WORKING', max_results=10)

        if orders_response.get('success'):
            print("\n--- Raw Working Order Data ---")
